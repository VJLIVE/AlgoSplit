        ...
        <div className="bg-[#1F2937] border border-[#374151] rounded-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-[#9CA3AF] text-sm">Connect your wallet to continue</p>
            </div>
          </div>
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            className="w-full bg-[#6366F1] text-white py-3 rounded-lg font-medium hover:bg-[#5558E3] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mb-6"
          >
            {loading ? (
              <>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-[#1F2937] text-[#9CA3AF]">New to AlgoSplit?</span>
            </div>
          </div>

          <button
            onClick={() => router.push('/signup')}
            className="w-full border border-[#374151] text-[#E5E7EB] py-3 rounded-lg font-medium hover:border-[#4B5563]"
          >
            Create Account
          </button>
        </div>
